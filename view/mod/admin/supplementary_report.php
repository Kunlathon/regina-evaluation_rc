...
<div class="row">
	<div class="col-<?php echo $grid;?>-12">
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				<h4> <span class="text-semibold">เรียนเสริมนอกตารางเรียน&nbsp;>&nbsp;</span>รายชื่อนักเรียนลงเรียน&nbsp;</h4>
			</ul>
		...
		<div class="panel panel-body border-top-pink" style="text-align: center;">
			<select class="select"  name="ra_class" id="ra_class" data-placeholder="ระดับชั้น...">
				...
				<optgroup label="ระดับชั้น">
					<option value="1113">ประถมศึกษาตอนต้น</option>
					<option value="2123">ประถมศึกษาตอนปลาย</option>
					<option value="1223">ประถมศึกษาปีที่ 2 ถึง 6</option>
