<div class="row">
	<div class="col-sm-12 col-md-12 col-lg-12">
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				<h4> <span class="text-semibold">รายงาน SAR </span>  ข้อมูลเกรดผลการเรียน กลุ่มวิชาพื้นฐาน </h4>
			</ul>
			...
			<div class="panel-body">
						<div class="row">
							...
							<div class="form-group">
								...
								<select name="txt_class" id="txt_class" data-placeholder="ชั้นเรียน..." class="select">
									<option></option>
									<optgroup>
							<?php
								$level_sql="SELECT `IDLevel`,`PLevel`,`Lname` FROM `rc_level` Where `IDLevel` !='3' and `IDLevel` !='44'";
								$level_rs=rc_array($level_sql);
								foreach($level_rs as $rc_key=>$level_rom){ ?>
									<option value="<?php echo $level_rom["IDLevel"];?>"><?php echo $level_rom["Lname"];?></option>
