...
<div class="row">
	<div class="col-<?php echo $grid;?>-12">
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				<h4> <span class="text-semibold">แบบสำรวจนักเรียนที่มีความสามารถพิเศษ </span></h4>
			</ul>
			<ul class="breadcrumb-elements">
				<div class="heading-btn-group">
					<a href="./?evaluation_mod=home" class="btn btn-link  text-size-small"><span>หน้าแรก</span></a>
					<a class="btn btn-link  text-size-small"><span>/</span></a>
					<a class="btn btn-link  text-size-small"><span>ข้อมูลความสนใจหรือกิจกรรมที่ประสงค์อยากให้ทางโรงเรียนส่งเสริมหรือจัดกิจกรรม</span></a>
				</div>
			</ul>
		</div>
	</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
					...
					<div class="row">
						<div class="col-<?php echo $grid;?>-4">
							<div class="form-group">
								<select class="select-search" name="stu_year" id="NGstu_year"> 
						...
						<div class="col-<?php echo $grid;?>-4">
							<div class="form-group">
								<select class="select" name="stu_class" id="NGstu_class">
				...
				<?php	} ?>										
						...
						<div class="col-<?php echo $grid;?>-4">
							<div class="form-group">
								<select class="select" name="stu_room" id="NGstu_room">
