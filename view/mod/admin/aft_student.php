<div class="row">
	<div class="col-sm-12 col-md-12 col-lg-12">
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				<h4> <span class="text-semibold">สรุปยอดนักเรียน </span>  ประเมินความพึงพอใจการจัดการเรียนการสอน </h4>
			</ul>
			<ul class="breadcrumb-elements">
				<div class="heading-btn-group">
					...
					<a class="btn btn-link  text-size-small"><span>/</span></a>
					<a href="./?evaluation_mod=favorite_data" class="btn btn-link  text-size-small"><span>สรุปยอดนักเรียน ประเมินความพึงพอใจการจัดการเรียนการสอน</span></a>
				</div>
			</ul>
		</div>
	</div>
