		...
		<div class="breadcrumb-line breadcrumb-line-component">
			...
			<ul class="breadcrumb-elements">
				<div class="heading-btn-group">
					...
					<a class="btn btn-link  text-size-small"><span>/</span></a>
					<a href="./?evaluation_mod=favorite_score" class="btn btn-link  text-size-small"><span>ผลคะแนน โหวตคุณครูในดวงใจของหนู</span></a>
				</div>
			</ul>
		</div>
	</div>
						...
						<div class="row">
							<div class="col-sm-6 col-md-6 col-lg-6">
								<div class="form-group">
									<label>ลำดับ</label>
										<select name="txt_count" id="txt_count" data-placeholder="ลำดับ..." class="select">
											<option></option>
											<optgroup>
										<?php
											$count=1;
											while($count<=15){ ?>
												<option value="<?php echo $count;?>"><?php echo $count;?> ลำดับ</option>
									<?php	$count=$count+1;	
											}
										?>	
											</optgroup>
