...
$(document).ready(function() {
    $("#scu_year,#scu_class").change(function() {
        ...
        if (ScuYear != "" && ScuClass != "") {
            $.post("<?php echo $golink;?>/view/mod/admin/code/summer_score_upload/RunSummerScore.php", {
                txtyear: ScuYear,
                txtclass: ScuClass
            }, function(scu) {
                if (scu != "") {
...
<script>
$(document).ready(function() {
    $("#load_year,#load_class").on('change', function() {
        var load_year = $("#load_year").val();
        var load_class = $("#load_class").val();
        if (load_year != "" || load_class != "") {
            $.post("<?php echo $golink;?>/Summer_score_upload/print_rssubject", {
                load_year: load_year,
                load_class: load_class
            }, function(Run_Rssubject) {
                if (Run_Rssubject != "") {
                    $("#load_subject").html(Run_Rssubject);
                } else {}
            })
        } else {}
    })
...
<script>
$(document).ready(function() {
    $("#load_year,#load_class,#load_subject").on('change', function() {
        var load_year = $("#load_year").val();
        var load_class = $("#load_class").val();
        var load_subject = $("#load_subject").val();
        var load_user="<?php echo $user_login;?>";
        if (load_subject != "") {
            $.post("<?php echo $golink;?>/Summer_score_upload/load_excel", {
                load_year: load_year,
                load_class: load_class,
