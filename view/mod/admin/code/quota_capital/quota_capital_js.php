	...
	<script>
		$(document).ready(function () {
			$("#txt_year,#txt_level,#txt_capital").change(function (){
				var data_level=$("#txt_level").val();
				var data_year=$("#txt_year").val();
				var data_capital=$("#txt_capital").val();
				if(data_year!="" && data_level!="" && data_capital!=""){
					$.post("view/mod/admin/code/quota_capital/quota_stu.php",{
						copy_level:data_level,
						copy_year:data_year,
						copy_capital:data_capital
