...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
	<?php
			...
			foreach($ShowPalnClass->RunPrintSummerPlan() as $rc=>$PrintPlanClass){
				...
				if(($PrintPlanClass["Plan_ID"]==0)){
					$PrintPlanName="ลงเรียนได้ทุกแผนการเรียน";
				}else{
					$PrintPlan=new print_plan($PrintPlanClass["Plan_ID"]);
					$PrintPlanName=$PrintPlan->plan_LName;
				}
			...
			<div class="row">
				<div class="col-<?php echo $grid; ?>-12">
					<h6 class="content-group text-semibold">
						<div><?php echo $PrintPlanName;?></div>
					</h6>
				</div>
			</div>		
			<div class="row">
