												...
												<div class="row">
													<div class="col-<?php echo $grid;?>-12">
														<center>
															...
															<a href="<?php echo $golink;?>/Print_imgstu/print_stu_card/<?php echo $rsd_studentid;?>/<?php echo $copy_year;?>" target="_blank"><button type="button" class="btn btn-warning">พิมพ์บัตรนักเรียน</button></a>
														</center>
													</div>
												</div>												
