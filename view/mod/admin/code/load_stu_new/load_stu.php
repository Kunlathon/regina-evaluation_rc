...
<!--****************************************************************************-->	
	...
	<div class="row RuningLoad">
		<?php
			$LoadStuNew=new LoadStuNew($txt_year);
		?>
			...
			<div class="col-<?php echo $grid;?>-12">
				<div class="panel bg-primary">
					<div class="panel-heading">
						<h6 class="panel-title">โหลดข้อมูลปีการศึกษา &nbsp;<?php echo $txt_year;?>&nbsp;</h6>
					</div>
						...
						<div class="row">
								...
								<div class="panel panel-body bg-success-400 has-bg-image">
									<div class="media no-margin">
										<div class="media-body">
											<h3 class="no-margin"><?php echo $LoadStuNew->Count_StuNew;?></h3>
											<span class="text-uppercase text-size-mini">จำนวนข้อมูลนักเรียนใหม่</span>
										</div>
							...
							<div class="col-<?php echo $grid;?>-4">
								<div class="panel panel-body bg-info-400 has-bg-image">
									<div class="media no-margin">
										<div class="media-body">
											<h3 class="no-margin"><?php echo $LoadStuNew->Count_Save;?></h3>
							...
							<div class="col-<?php echo $grid;?>-4">
								<div class="panel panel-body bg-danger-400 has-bg-image">
									<div class="media no-margin">
										<div class="media-body">
											<h3 class="no-margin"><?php echo $LoadStuNew->Count_NotSave;?></h3>
