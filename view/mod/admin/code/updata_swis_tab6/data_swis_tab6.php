        ...
        buttons: {            
            buttons: [
                ...
                },
                {
                    extend: 'excelHtml5',
                    className: 'btn btn-default',
					filename: 'tab6  ชั้น <?php echo $txt_level->level_Sort_name;?> / <?php echo $txt_room;?> ภาคเรียนที่ <?php echo $txt_t;?> ปีการศึกษา <?php echo $txt_y;?>',
					title: 'tab6  ชั้น <?php echo $txt_level->level_Sort_name;?> / <?php echo $txt_room;?>  ภาคเรียนที่ <?php echo $txt_t;?> ปีการศึกษา <?php echo $txt_y;?>',
                    exportOptions: {
                        columns: ':visible'
                    }
                },
...
<div class="row">
	<div class="col-<?php echo $grid;?>-12">
		<div class="panel panel-success">
			<div class="panel-heading">tab6 ชั้น <?php echo $txt_level->level_Sort_name;?> / <?php echo $txt_room;?>  ภาคเรียนที่ <?php echo $txt_t;?> ปีการศึกษา <?php echo $txt_y;?></div>
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
								<td><?php echo $rsd_studentid;?></td>
								<td><?php echo$parent_prefix->prefix_prefix_SName;?></td>			
								<td><?php echo$call_stu_guardian->parent_fname;?></td>			
								<td><?php echo$call_stu_guardian->parent_sname;?></td>			
			<?php
					if($call_stu_guardian->parent_birthday==""){ ?>
								<td></td>					
			<?php	}else{ ?>
								<td><?php echo date("d/m/Y",strtotime($call_stu_guardian->parent_birthday));?></td>	
			<?php	} ?>		
