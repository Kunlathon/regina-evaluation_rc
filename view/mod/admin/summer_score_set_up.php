...
<div class="row">
	<div class="col-<?php echo $grid;?>-12">
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				<h4> <span class="text-semibold">กิจกรรมเรียนเสริมภาคฤดูร้อน&nbsp;>&nbsp;</span>ลงทะเบียนวิชา&nbsp;/&nbsp;กิจกรรมสำหรับวัดและประเมินผล&nbsp;</h4>
			</ul>
			<ul class="breadcrumb-elements">
				<div class="heading-btn-group">
					<a href="./?evaluation_mod=home" class="btn btn-link  text-size-small"><span>หน้าแรก</span></a>
					<a class="btn btn-link  text-size-small"><span>/</span></a>
					<a class="btn btn-link  text-size-small"><span>&nbsp;ลงทะเบียนวิชา&nbsp;/&nbsp;กิจกรรมสำหรับวัดและประเมินผล&nbsp;</span></a>
				</div>
			</ul>
		</div>
	</div>
...
<div id="run_rssubject">
	<div class="row">
		...
		<div class="col-<?php echo $grid;?>-6">
			<div class="panel panel-body border-top-violet">
				<input type="number" name="up_score" id="up_score" min="10" max="100" readonly="readonly" required="required" class="form-control" placeholder="ระบุคะแนนเต็ม">
			</div>
		</div>	
	</div>
</div>