...
<div class="row">
	<div class="col-<?php echo $grid;?>-12">
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				<h4> <span class="text-semibold">การจัดการและการบริหารระบบ</span> เชื่อมต่อข้อมูลนักเรียนใหม่เข้าสู่ระบบ</h4>
			</ul>
			<ul class="breadcrumb-elements">
				<div class="heading-btn-group">
					<a href="./?evaluation_mod=home" class="btn btn-link  text-size-small"><span>หน้าแรก</span></a>
					<a class="btn btn-link  text-size-small"><span>/</span></a>
					<a class="btn btn-link  text-size-small"><span>เชื่อมต่อข้อมูลนักเรียนใหม่เข้าสู่ระบบ</span></a>
				</div>
			</ul>
		</div>
	</div>
	...
	<div class="col-<?php echo $grid;?>-12">
		<div class="panel">
			<div class="panel-heading bg-primary">
				<h6 class="panel-title">เชื่อมต่อข้อมูลนักเรียนใหม่ จากระบบรับสมัครนักเรียน เข้าสู่ระบบ</h6>
			</div>
