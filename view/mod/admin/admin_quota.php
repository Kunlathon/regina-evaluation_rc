...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
	<?php 
		...
		foreach($quota_transfer_test->print_quotanotarray() as $quota=>$quota_transfer_testRow){
			...
			?>
<!--////////////////////////////////////////////////////////-->	
<form name="quota" method="post" action="quota_print/print_quota/<?php echo $data_yaer;?>/<?php echo $studentid;?>" target="_blank">
<div class="row">
...
<!--*******************************************************************************************************************************-->						
			...
			<div class="row">
				...
				<div class="col-<?php echo $grid;?>-6">
					<button type="button" id="gowork" class="btn btn-warning">กลับ ข้อมูลนักเรียนได้รับสิทธิ์โควต้า</button>
				</div>
			</div>
