	...
	<script>
		$(document).ready(function () {
			$("#parent_addwordprovince").change(function () {
				...
				if(province!=""){
					$.post("view/mod/student/code/profile/p_word/pword_city.php",{
	...
	<script>
		$(document).ready(function () {
			$("#parent_addwordamphur").change(function () {
				...
				if(city!=""){
					$.post("view/mod/student/code/profile/p_word/pword_amphures.php",{
						txt_city:city
					},function(datacity){
						if(datacity!=""){
	...
	<script>
		$(document).ready(function () {
			$("#parent_addwordtumbon").change(function () {
				...
				if(zip!=""){
					$.post("view/mod/student/code/profile/p_word/pword_zip.php",{
						txt_zip:zip
					},function(datacity){
						if(datacity!=""){
	...
	<script>
		$(document).ready(function () {
			$("#parent_province").change(function () {
				...
				if(province!=""){
					$.post("view/mod/student/code/profile/p_add/padd_city.php",{
						txt_province:province
					},function(dataprovince){
						if(dataprovince!=""){
	...
	<script>
		$(document).ready(function () {
			$("#parent_amphur").change(function () {
				...
				if(city!=""){
					$.post("view/mod/student/code/profile/p_add/padd_amphures.php",{
						txt_city:city
					},function(datacity){
						if(datacity!=""){
	...
	<script>
		$(document).ready(function () {
			$("#parent_tumbon").change(function () {
				...
				if(zip!=""){
					$.post("view/mod/student/code/profile/p_add/padd_zip.php",{
						txt_zip:zip
					},function(datacity){
						if(datacity!=""){
...
<!--********************************************************-->	
	<div class="row">
		<div class="col-<?php echo $grid;?>-12">
			<center><font color="#2F03F9"><h4><b>ข้อมูลอ้างอิงจาก ข้อมูลเจ้าของหอพัก</b></h4></font></center>
		</div>
	</div>	
						...
						<fieldset class="content-group">
							<div class="form-group">
								...
								<div class="col-<?php echo $grid;?>-9">
									<select name="parent_prefix" id="parent_prefix" data-placeholder="คำนำหน้า (ภาษา(ภาษาไทย)).." class="select-size-<?php echo $grid;?>">
										<option></option>
							...
							<div class="form-group">
								...
								<div class="col-<?php echo $grid;?>-10">
									<div class="input-group">
										<input type="text" class="form-control" placeholder="ชื่อ (ภาษาไทย)" size="100" name="parent_fname" id="parent_fname" value="<?php echo $stu_guardianRow["parent_fname"];?>" maxlength="100">
									</div>
								</div>
							</div>
                        </fieldset>
					...
					<div class="col-<?php echo $grid;?>-4">
						<fieldset class="content-group">
							<div class="form-group">
								...
								<div class="col-<?php echo $grid;?>-9">
									<div class="input-group">
										<input type="text" class="form-control" placeholder="นามสกุล (ภาษาไทย)" size="100" name="parent_sname" id="parent_sname" value="<?php echo $stu_guardianRow["parent_sname"];?>" maxlength="100">
									</div>
								</div>
							</div>
                        </fieldset>					
					...
					<div class="col-<?php echo $grid;?>-4">
						<fieldset class="content-group">
							<div class="form-group">
								...
								<div class="col-<?php echo $grid;?>-9">
									<select name="parent_prefix_en" id="parent_prefix_en"  data-placeholder="คำนำหน้าภาษา(ภาษาอังกฤษ).." class="select-size-<?php echo $grid;?>">
										<option></option>
						...
						<fieldset class="content-group">
							<div class="form-group">
								...
								<div class="col-<?php echo $grid;?>-6">
									<div class="input-group">
										<input type="text" class="form-control" placeholder="เลขประจำตัวประชาชน" size="100" name="parent_code" id="parent_code" value="<?php echo $stu_guardianRow["parent_code"];?>" maxlength="13"> 
									</div>
								</div>
							</div>
                        </fieldset>
