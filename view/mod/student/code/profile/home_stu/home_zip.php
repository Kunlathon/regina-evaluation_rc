	...
	foreach($districtsRs->datastu_array as $rc_key=>$districtsRow){
		$DISTRICT_CODE=$districtsRow["DISTRICT_CODE"];
			...
			$zipcode=$zipRow["zipcode"]; ?>
				<input type="text" name="stu_reg_zipcode" id="stu_reg_zipcodecopy" class="form-control" placeholder="รหัสไปรษณีย์" readonly="readonly" value="<?php echo $zipcode;?>" size="100" maxlength="6" >
<?php	}		
