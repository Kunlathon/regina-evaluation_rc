...
<?php
	//time run------------------------------------------------------------------------------------  
		$datetime=date("Y-m-d H:i:s",strtotime("2023-07-01 00:00:00"));//สิ้นสุดการลงทะเบียน
...
<div class="row">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <font style="color: #0642FA; font-size: 16px; font-family: THSarabunNew;">
                                            ...
                                            <div>
                                                <?php //echo $show_num_activity->ak_count."/".$show_num_activity->ak_keep;?> <?php echo $test_count_all->test_sum_activity_print()."/".$activity_quota;?>
                                            </div>
                                        </font>
                                    </div>
    ...
    <?php   }else{ ?>
                            <div class="panel panel-body" style="background-color: #FF0000">
                                <div class="media">
                                    <div class="media-left">
                                        <i class="icon-magazine text-success-400 icon-2x no-edge-top mt-5"></i>
                                    </div>
...
<div class="row">
    <div class="col-<?php echo $grid;?>-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-<?php echo $grid;?>-3">
                        <a id="Btn_activity<?php echo $hr_arc;?>" data-toggle="tooltip" title="<?php echo $call_activityRow["activity_txt"];?>">
    ...
    <?php   }else{ ?>
                                 <div class="modal-footer">
                                    <form name="activityA" action="./?evaluation_mod=activity_show" method="post" accept-charset="UTF-8">
                                        <input type="hidden" name="activity_key" value="<?php echo $call_activityRow["activity_key"];?>">
                                        <button type="button" class="btn btn-danger" name="code_key" value="key_system">ครบจำนวนแล้ว</button>
                                        <button type="button" class="btn btn-warning" data-dismiss="modal">ปิด</button>
                                    </form>
                               </div>
    <?php   } ?>
...
<?php
	//time run------------------------------------------------------------------------------------  
		$datetime=date("Y-m-d H:i:s",strtotime("2023-06-01 00:00:00"));//สิ้นสุดการลงทะเบียน
		$datetime_cr=date("Y-m-d H:i:s");
		$datatime_notrun=strtotime($datetime);
		$datatime_run=strtotime($datetime_cr);
			if(($datatime_run>=$datatime_notrun)){
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <font style="color: #0642FA; font-size: 16px; font-family: THSarabunNew;">
                                            <div><b><?php echo $call_activityRow["activity_txt"];?></b></div>
                                            <div>
                                                <?php //echo $show_num_activity->ak_count."/".$show_num_activity->ak_keep;?>
                                            </div>
                                        </font>
                                    </div>
                                </div>
...
<!--*******************************************************************************************-->
<?php
						$datetimeON="2023-05-07 00:00:00";	
						$datetime_crON=date("Y-m-d H:i:s");
						//$datetime_crON=$datetimeON;
						$datatime_notrunON=strtotime($datetimeON);
						$datatime_runON=strtotime($datetime_crON);	
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <font style="color: #0642FA; font-size: 16px; font-family: THSarabunNew;">
                                            ...
                                            <div>
                                                <?php //echo $show_num_activity->ak_count."/".$show_num_activity->ak_keep;?> <?php echo $test_count_all->test_sum_activity_print()."/".$activity_quota;?>
												<?php echo $test_count_all->test_activity_txt()."*";?>
                                            </div>
                                        </font>
                                    </div>
