<form name="account_settings" method="post" action="view/mod/student/code/account_settings/account_settings_code.php" >
<div class="row">
	...
	<?php
		$model1="SELECT `model1` FROM `regina_stu_login` WHERE `rsd_studentid`='{$user_login}';";
	...
	<?php
		$model2="SELECT `model2` FROM `regina_stu_login` WHERE `rsd_studentid`='{$user_login}';";
