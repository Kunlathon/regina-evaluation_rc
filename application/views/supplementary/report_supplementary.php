...
<html>
	<head>
		...
		<title>รายงานรายชื่อนักเรียนลงเรียน&nbsp;กิจกรรม</title>
...
<!--****************************************************************************-->		
				...
				buttons: {            
					buttons: [
						...
						},
						{
							extend: 'excelHtml5',
							className: 'btn btn-default',
							filename: 'รายงานรายชื่อนักเรียนลงเรียน กิจกรรม <?php echo $txt_name;?> ระดับชั้น <?php echo $PrintClass;?> ภาคเรียนที่ <?php echo $txt_t;?>  ปีการศึกษา <?php echo $txt_y;?>',
					        title: 'รายงานรายชื่อนักเรียนลงเรียน กิจกรรม <?php echo $txt_name;?> ระดับชั้น <?php echo $PrintClass;?> ภาคเรียนที่ <?php echo $txt_t;?> ปีการศึกษา <?php echo $txt_y;?>',
							exportOptions: {
								columns: ':visible'
							}
						}
	...
	<body>
		...
		<?php	
				$count=1;
				$SudSupplement=new CountSudSupplement($txt_name,$txt_t,$ClassA,$ClassB,$txt_y);
				foreach($SudSupplement->RunCountSudSupplementPrint() as $rc=>$SudSupplementRow){ 
					$Printclass=new PrintReginaYear4($txt_y,$txt_t,$SudSupplementRow["sup_stuid"]);
