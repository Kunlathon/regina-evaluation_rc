...
//------------------------------------------------------------------------------
	...
	<section class="sheet padding-10mm imgA">
		...
		<table style="width: 724;" border="0" cellpadding="0" cellspacing="0">
			<tr>
                <td>
                    <div style="font-size: 25px; font-weight: bold;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ข้อมูลด้านการศึกษา</div>
                </td>
			</tr>
		</table>
		<br>
		<table style="width: 724;" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <div style="font-size: 20px; font-weight: bold;">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <b>เข้าศึกษาที่โรงเรียนเรยีนาเชลีวิทยาลัย ปีการศึกษา </b>
                        <input type="text" readonly="readonly" required="required" style="font-family: THSarabunNew; font-size: 20px; border:0px; text-align: left; border:0px; border-bottom:#000 1px dotted; font-weight: lighter" size="23" value="">
                            
                        <b>ในระดับชั้น</b>
						<input type="text" readonly="readonly" required="required" style="font-family: THSarabunNew; font-size: 20px; border:0px; text-align: left; border:0px; border-bottom:#000 1px dotted; font-weight: lighter" size="24" value="">
		...
		<br>
		<table style="width: 690px;" border="1" cellpadding="0" cellspacing="0" align="right">
            <thead>
                <tr>
                    <th style="width: 120px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">ปีการศึกษา</div>
                    </th>
                    <th style="width: 120px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">ระดับชั้น</div>
                    </th>
                    <th style="width: 70px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">ผลการเรียน ภาคเรียนที่ 1</div>
                    </th>
                    <th style="width: 70px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">ผลการเรียน ภาคเรียนที่ 2</div>
                    </th>
					<th style="width: 310px;">
						<div  style="font-size: 18px; font-weight: bold; text-align: center;">หมายเหตุ</div>
					</th>
                </tr>                
            </thead>
            <tbody>
    ...
    ?>
		...
		<table style="width: 724;" border="0" cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                    <td  style="width: 690 px;">
                        <div  style="font-size: 25px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;หน้าที่พิเศษในโรงเรียน</div>
                    </td>
                </tr>
            </tbody>
        </table>
		
		<table style="width: 690;" border="1" cellpadding="0" cellspacing="0" align="right">
            <thead>
                <tr>
                    <th style="width: 100px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">ปีการศึกษา</th>
                    </th>
                    <th style="width: 100px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">ระดับชั้น</th>
                    </th>
                    <th style="width: 262px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">หน้าที่</th>
                    </th>
                </tr>                
            </thead>
            <tbody>
    ...
    <section class="sheet padding-10mm imgA">
            ...
            <tbody>
                <tr>
                    <td  style="width: 724px;">
                        <div  style="font-size: 25px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;สำหรับครูแนะแนว</div>
                        <div  style="font-size: 20px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ข้อมูลแบบทดสอบบุคสิกภาพและความสนใจ</div>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table style="width: 690;" border="1" cellpadding="0" cellspacing="0" align="right">
            <thead>
                <tr>
                    <th style="width: 100px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">วันเดือนปี</th>
                    </th>
                    <th style="width: 100px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">เรื่อง</th>
                    </th>
                    <th style="width: 262px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">ผลการทดสอบ</th>
                    </th>
                </tr>                
            </thead>
            <tbody>
    ...
    ?>
        ...
        <table style="width: 724px;" cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                    <td  style="width: 724px;">
                        <div  style="font-size: 25px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;สำหรับครูประจำชั้น</div>
                        <div  style="font-size: 20px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;บันทึกเพิ่มเติม</div>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table style="width: 690;" border="1" cellpadding="0" cellspacing="0" align="right">
            <thead>
                <tr>
                    ...
                    <th style="width: 100px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">รายละเอียด</th>
                    </th>
                    <th style="width: 262px;">
                        <div  style="font-size: 18px; font-weight: bold; text-align: center;">ผู้บันทึก</th>
                    </th>
                </tr>                
            </thead>
            <tbody>
