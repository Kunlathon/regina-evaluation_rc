...
<!--****************************************************************************-->		
	...
	<body>
		...
		<?php
			$DeleteListConcertCopy=new ManagementPayingKeyConcert("DeleteLCCAll","-","-","-","-","-","-",$DLA_Key);
				if($DeleteListConcertCopy->RunMPKC_Error()=="NoERROR"){
					exit("<script>window.location='$golink/?evaluation_mod=concert_pay';</script>");
				}elseif($DeleteListConcertCopy->RunMPKC_Error()=="ERROR"){
					exit("<script>window.location='$golink/?evaluation_mod=concert_pay';</script>");
				}else{
					exit("<script>window.location='$golink/?evaluation_mod=concert_pay';</script>");
				}
