...
<html lang="en" dir="ltr">
	<head>
		...
		<title>พิมพ์รูปนักเรียนขนาด&nbsp;2&nbsp;นิ้ว</title>
...
<!--Code Print js End-->
	...
	<section class="sheet padding-10mm" id="imgA">
		<table>
			<tbody>
				<tr>
					<td><div><img src="<?php echo base_url();?>/view/all/<?php echo $user_img;?>" style="width: 4.00cm; height: 5.23cm" class="img-thumbnail"/></div></td>
					<td><div><img src="<?php echo base_url();?>/view/all/<?php echo $user_img;?>" style="width: 4.00cm; height: 5.23cm" class="img-thumbnail"/></div></td>
					<td><div><img src="<?php echo base_url();?>/view/all/<?php echo $user_img;?>" style="width: 4.00cm; height: 5.23cm" class="img-thumbnail"/></div></td>
					<td><div><img src="<?php echo base_url();?>/view/all/<?php echo $user_img;?>" style="width: 4.00cm; height: 5.23cm" class="img-thumbnail"/></div></td>
				</tr>
